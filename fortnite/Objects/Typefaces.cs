...
public class Typefaces
{
    ...
    private readonly StreamedFileProvider _viewModel;
    ...
    public Typefaces(StreamedFileProvider viewModel )
    {
        _viewModel = viewModel;
        var language = ELanguage.Arabic;

        Default = OnTheFly(_FORTNITE_BASE_PATH +
                                       language switch
                                       {
    ...
    {
        if (!_viewModel.TrySaveAsset(path, out var data)) return fallback ? null : Default;
