...
{
    public string _id { get; set; } = "Nightwatcher";
    public DateTime created { get; set; } = DateTime.Now;
    public DateTime updated { get; set; } = DateTime.Now;
    public int rvn { get; set; } = 69;
    public int wipeNumber { get; set; } = 1;
    public string accountId { get; set; } = "Nightwatcher";
    public string profileId { get; set; } = "athena";
    public string version { get; set; } = "Nightwatcher";
    ...
    public class Attributes
    {
        ...
        public string locker_name { get; set; } = "Nightwatcher";
